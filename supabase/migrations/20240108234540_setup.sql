...
AS $$
DECLARE
  project_url TEXT := 'https://gvfxsspgrrbpagiyobak.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd2Znhzc3BncnJicGFnaXlvYmFrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczMTEzMjY5OSwiZXhwIjoyMDQ2NzA4Njk5fQ.ZqPq3qfsAPwqaSoHtd9Xp63JFeME3Khzu-6wOtquNh8'; -- full access needed for http request to storage
